...
public class BrightnessBlueFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View viewRoundCorner = inflater.inflate(R.layout.fragment_brightness_blue, container, false);

        BitmapDrawable bitmapDrawable = (BitmapDrawable) EditActivity.image.getDrawable();
        bitmap = bitmapDrawable.getBitmap();
        seekBar = viewRoundCorner.findViewById(R.id.seekBarCorner_blue);
        seekBar.setProgress(125);

        seekBar2 = viewRoundCorner.findViewById(R.id.seekBarCorner_blue2);
    ...
    public static PorterDuffColorFilter setBrightness(int progress) {
        if (progress >=    100)
        {
            ...
            return new PorterDuffColorFilter(Color.argb(value, 0, 4, 224), PorterDuff.Mode.SRC_OVER);

        }
        else
        {
            int value = (int) (100-progress) * 200 / 100;
            return new PorterDuffColorFilter(Color.argb(value, 0, 4, 224), PorterDuff.Mode.SRC_ATOP);
    ...
    public static PorterDuffColorFilter setBrightness2(int progress2) {
        if (progress2 >=    100)
        {
            ...
            return new PorterDuffColorFilter(Color.argb(value, 0, 202, 224), PorterDuff.Mode.SRC_OVER);

        }
        else
        {
            int value = (int) (100-progress2) * 200 / 100;
            return new PorterDuffColorFilter(Color.argb(value, 0, 202, 224), PorterDuff.Mode.SRC_ATOP);
